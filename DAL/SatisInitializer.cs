        ...
        protected override void Seed(SatisContext context)
        {
            ...
            List<Urun> urunler = new List<Urun>
            {
                ...
                new Urun { Ad = "Ultrabook", Fiyat = 3000, KategoriId = kategoriBilgisayar.Id,
                    Stok = 85},
                new Urun { Ad = "Smartphone", Fiyat = 2000, KategoriId = kategoriCepTelefonu.Id,
                    Stok = 1000},
                new Urun { Ad = "Tabphone", Fiyat = 3000, KategoriId = kategoriCepTelefonu.Id,
                    Stok = 50},
                new Urun { Ad = "Led TV", Fiyat = 3500, KategoriId = kategoriTelevizyon.Id,
                    Stok = 50},
                new Urun { Ad = "LCD TV", Fiyat = 1100, KategoriId = kategoriTelevizyon.Id,
                    Stok = 30},
                new Urun { Ad = "Plazma TV", Fiyat = 2250, KategoriId = kategoriTelevizyon.Id,
                    Stok = 20},
            };
